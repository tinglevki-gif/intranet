...
DEFAULT_SYSTEM_ROLES_CONFIG = [
    ...
    {
        "name": "IT-Administration & Systemleitung",
        "slug": "IT_ADMIN",
        "description": "Verwaltung der gesamten IT-Infrastruktur, Benutzeraccounts, Rollen, Helpdesk, Tischplan und Systeme.",
        "is_system_role": True,
        "permissions": {
            "kantine": "read_write",
            "gps": "read_write",
            ...
            "planung": "admin",
            "schulungen": "admin",
            "phone-directory": "admin",
            "org-chart": "admin",
            "directory": "admin",
            "documents": "admin",
            "calendar": "read_write",
            "hr-requests": "read_write",
            "performance": "read_write",
            "it-management": "admin",
            "it-helpdesk": "admin",
            "admin-users": "admin",
            "admin-roles": "admin",
    ...
    },
    {
        ...
        "slug": "MANAGEMENT",
        "description": "Unternehmensführung, Gesamtübersicht aller Abteilungen, KPIs, Berichte, Verträge und Freigaben.",
    ...
    {
        "name": "Geschäftsentwicklung",
        "slug": "BUSINESS_DEV",
        "description": "Strategische Marktentwicklung, Partnerschaften, Vertriebsausbau und Unternehmenswachstum.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "read",
    ...
    },
    {
        ...
        "slug": "RECEPTION",
        "description": "Telefonzentrale, Besucherempfang, Poststelle, Kantinenbestellungen und interne Kontakte.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "none",
    ...
    },
    {
        ...
        "slug": "SALES",
        "description": "Kundenakquise, Kalkulation, Bauprojekte-Angebote, Verträge und Vertriebs-Dashboards.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "read_write",
    ...
    {
        "name": "Qualitätssicherung & Kontrolle",
        "slug": "CONTROLLING_QS",
        "description": "Qualitätsprüfungen, Baustoffprüfungen, Laborberichte, Prüfprotokolle und Werksaudits.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "read",
    ...
    },
    {
        "name": "Technik & Statik",
        "slug": "TECHNIK",
        "description": "Konstruktionszeichnungen, Elementpläne, CAD-Bewehrungspläne, Statik und Maschineninstandhaltung.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "read",
    ...
    },
    {
        ...
        "slug": "ACCOUNTING",
        "description": "Kreditoren-/Debitorenbuchhaltung, Rechnungsprüfung, Zahlungsverkehr, Kostenrechnung und Finanzen.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "none",
    ...
    {
        "name": "Produktion & Planung",
        "slug": "PRODUKTION",
        "description": "Tischplan-Reader, Kipptisch-Belegung, Betonmisch-Aufträge, Schichtplanung und Fertigungsstraßen.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "read_write",
    ...
    {
        "name": "Auftragsabwicklung & Disposition",
        "slug": "ABWICKLUNG",
        "description": "Baustellen-Disposition, Liefertermine, Schwerlast-Transporte, Verladung und Kundenabwicklung.",
        "is_system_role": False,
        "permissions": {
            "kantine": "read_write",
            "gps": "admin",
